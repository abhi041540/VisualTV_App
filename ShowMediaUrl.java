...
//	         });
         ...
         WebElement ses=wd.findElement(By.cssSelector("hdvbplayer:nth-child(15) hdvbplayer hdvbplayer:nth-child("+seson+")"));
         jse.executeScript("arguments[0].click();",ses);
         if(ep==0)
         {
        	 ep=1;
         }
         WebElement eps=wd.findElement(By.cssSelector("hdvbplayer:nth-child(14) hdvbplayer hdvbplayer:nth-child("+ep+")"));
         jse.executeScript("arguments[0].click();",eps);
         if(lenguage==null)
         {
        	 lenguage="Hindi";
         }
         ...
         for(WebElement lnm:len)
         {
        	 try
        	 {
          	...
          	if(nm1.equalsIgnoreCase(lenguage))
          	{
          		jse.executeScript("arguments[0].click();",lnm);
         ...
         WebDriverWait wat= new WebDriverWait(wd,Duration.ofSeconds(1));
         System.out.println("video component");
	      ...
	      String script = "(function() {" +
	    		...
	    		Thread.sleep(15000); // Wait for 20 seconds to ensure all URLs are captured
...
//		 System.out.println(oum);
	...
	{
		System.out.println(getUrl("SWEET",2,4,"hindi"));
	}
}
